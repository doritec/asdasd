  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-8 w-full max-w-sm">
        <h2 className="text-xl font-bold mb-6 text-center text-gray-900">Login with Aimwizards</h2>
              ...
              <div className="w-full max-w-[320px] flex flex-col gap-2">
                <div className="bg-[#121212] border border-gray-800 rounded-sm p-8 flex flex-col items-center">
                  ...
                  <div className="w-[120px] h-[120px] mb-3">
                    <img 
                      src="https://images.unsplash.com/photo-1614027164847-1b28cfe1df60?w=300&h=300&fit=crop&q=80"
                      alt="Profile"
                  ...
                  {/* Username */}
                  <h2 className="text-lg font-semibold mb-6 text-white">Aimwizards</h2>
